...
public class AppoimentFormController {
    ...
    private void setlistner(){
        tblAppoiment.getSelectionModel().selectedItemProperty()
                .addListener((observable,oldValue,newValue)->{
                    AppoimentDto dto=new AppoimentDto(
                            newValue.getId(),
                            newValue.getDate(),
                            newValue.getTime(),
                            newValue.getReturndate(),
                            newValue.getAppoiment_returnTime(),
                            newValue.getCustomer_id(),
                            newValue.getCar_id(),
                            newValue.getCar_name(),
                            newValue.getCar_price(),
                            newValue.getPayment()
    ...
    private void setfields(AppoimentDto dto) {
        lblAppoimentId.setText(dto.getId());
        txtAppoimentDate.setValue(LocalDate.parse(dto.getDate()));
        txtAppoimentTime.setText(dto.getTime());
        txtAppoimentReturnDate.setValue(LocalDate.parse(dto.getReturndate()));
        txtAppoimentTime.setText(dto.getAppoiment_returnTime());
        cmbCustId.setValue(dto.getCustomer_id());
        cmbCar_id.setValue(dto.getCar_id());
        lblCarName.setText(dto.getCar_name());
        lblCarPrice.setText(dto.getCar_price());
        txtTotalPrice.setText(dto.getPayment());
